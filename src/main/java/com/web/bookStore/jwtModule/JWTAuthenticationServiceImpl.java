...
public class JWTAuthenticationServiceImpl implements JWTAuthenticationService {
    ...
    public String createAuthorizedToken(UserEntity userEntity) {
        String token = null;
    ...
    @Override
    public UserEntity getUserByEmail(String authorization) {
        String email = JWT.decode(getJwtToken(authorization)).getClaim("email").asString();
        return jwtAuthenticationRepository.findById(email)
